  ...
  return (
    <div className="FAQ-main-container">
      <div className="FAQ-container">
        ...
        <h6 className="ans">
          You can collaborate with Aura Canvas by reaching out to us through our
          contact form on the website or by emailing our team directly.
        </h6>

        <h5 className="qs">
          Can individuals who are not celebrities or influencers work with Aura
          Canvas?
        </h5>
        <h6 className="ans">
        ...
        <h6 className="ans">
          Aura Canvas stands out by offering personalized support and tailored
          strategies to help clients succeed in their entrepreneurial ventures.
          We prioritize building long-term relationships and fostering growth
          for our partners.
        </h6>
        ...
        <h6 className="ans">
          ...
          business ventures. We offer guidance on leveraging data to optimize
